        ...
        <div
            ...
            <span class="px-3 py-1 text-sm bg-blue-100 text-blue-800 rounded-full dark:bg-blue-800 dark:text-blue-100">
                Membres: {{ $coloc->membership->whereNull('left_at')->count() }}
                            ...
                            <span
                                class="px-3 py-1 text-sm bg-green-100 text-green-800 rounded-full dark:bg-green-800 dark:text-green-100">
                Total Dépense: {{ $coloc->depenses()->sum('montant') }}
            </span>
                            <span
                                class="px-3 py-1 text-sm bg-yellow-100 text-yellow-800 rounded-full dark:bg-yellow-800 dark:text-yellow-100">
                Catégories: {{ $coloc->categories->count() }}
            </span>
                            <span
                                class="px-3 py-1 text-sm bg-red-100 text-red-800 rounded-full dark:bg-red-800 dark:text-red-100">
                Status: {{ $coloc->status }}
            </span>
                        </div>
                    </div>
