            ...
            <div class="container px-6 mx-auto grid">
                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <form action="{{ route('colocations.depenses.update',$colocation, $depense) }}" method="POST">
                        ...
                        @method('PUT')
                        <div>
                            <x-input-label for="titre" :value="__('Nombre maximum de membres')" />
                            <x-text-input id="titre" class="block mt-1 w-full" type="text" name="titre" :value="$depense->titre" required autofocus autocomplete="titre" />
